...
const OrderSummary = () => {
    ...
    const handlePayment = async () => {
        ...
        const res = await axios.post("http://localhost:5002/api/payments/create-checkout-session", {
            products: cart,
            ...
            <div className="space-y-4">
                <div className="space-y-2">
                    <dl className="flex items-center justify-between gap-4">
                        ...
                        <dd className="text-base font-semibold text-emerald-400">₹{formattedSubtotal}</dd>
                    </dl>
                    {savings > 0 && (
                        <dl className="flex items-center justify-between gap-4">
                    ...
                    {coupon && isCouponApplied && (
                        <dl className="flex items-center justify-between gap-4">
                            ...
                            <dd className="text-base font-semibold text-emerald-400">-{coupon.discountPercentage}%</dd>
                        </dl>
                    )}
